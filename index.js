...
// When called this will return DOM in string format of the players
app.get('/trade', (req, res) => {
    var d = require("./drafts.json")
    var s = require("./draft_settings.json")
    console.log(req.body.t)
    // Goes through the players picks
    var c_play = d[s["id"]][req.body.t]
})
...
io.on("connection", (socket) => {
    ...
    // This will get the given teams players
    ...
    socket.on("trade_decline", (data) => {
        socket.broadcast.emit("decline_trade", data)
    })
})
